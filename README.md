...
<td>
    <a href="example/example1.typ">
        <img src="example/example1.png" alt="Many colored Tromp diagrams showing the normalization process of the factorial of 2"/>
    </a>
</td>
<td>
    <a href="example/example2.typ">
        <img src="example/example2.png" alt="A Tromp diagram of the Church numeral 3 with blue labels"/>
    </a>
</td>
</tr>
</table>
